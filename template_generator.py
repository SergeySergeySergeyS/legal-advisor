...
- Универсальные правила подсудности (ст. 23, 24 ГПК РФ)
- Лимит 100 000 руб. для мировых судей
- 6 категорий: потребители, трудовые, ГИБДД, семейное, наследство, ЖКХ
- ТСТ (Постановление № 924)
- Освобождение от госпошлины (ст. 333.36 НК РФ)
- Альтернативная подсудность для потребителей (ст. 17 ЗоЗПП)
- Исключительная подсудность для недвижимости (ст. 30 ГПК РФ)
"""
...
VALID_LAWS_BY_CATEGORY = {
    ...
    "🚗 Споры с ГИБДД": [
        ...
        "осаго", "каско",
        "транспортн",
        "административн", "гпк рф"
    ],
    "👨‍👩‍👧 Семейное право": [
        "семейный кодекс", "ск рф",
        "алимент", "развод", "брачн",
        "раздел имуществ", "усыновлен",
        "гпк рф", "подсудн"
    ],
    "📜 Наследство": [
        "гражданский кодекс", "гк рф",
        "наследств", "завещан",
        "наследодател", "обязательн.*доля",
        "гпк рф"
    ],
...
1. ТРУДОВЫЕ СПОРЫ → ВСЕГДА районный суд (ст. 24 ГПК РФ). Мировые судьи трудовые дела НЕ рассматривают.
...
5. НАСЛЕДСТВЕННЫЕ СПОРЫ:
   - Имущественные споры (раздел наследства, признание права) с ценой иска ДО 100 000 руб. → Мировой судья.
   - Цена иска СВЫШЕ 100 000 руб. ИЛИ споры о признании наследника недостойным, оспаривание завещания → Районный суд.
   - Подсудность: по месту открытия наследства (ст. 29 ГПК РФ — исключительная подсудность, если спор о недвижимости).
...
- Наследство: признание права собственности, включение в наследственную массу
